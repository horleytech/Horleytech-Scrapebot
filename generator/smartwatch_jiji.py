    ...
    try:
        ...
        for element in product_elements:
            ...
            if name_element and price_element:
                ...
                if product_name in [
                    'Apple IWATCH SE (1ST GEN) brand new',
                    'Apple IWATCH ULTRA brand new',
                    ]:
                    name_words = name_element.text.lower().split()[:3]
                    input_words = product_name.lower().split()[:3]

                elif product_name in [
                    'Samsung GALAXY WATCH 5 PRO brand new',
                    'Samsung GALAXY WATCH 4 CLASSIC brand new',
                    ]:
...
if __name__ == "__main__":
    product_names = [
        'Apple IWATCH SE (1ST GEN) brand new',
        'Apple IWATCH SERIES 3 brand new',
        'Apple IWATCH SERIES 4 brand new',
        'Apple IWATCH SERIES 5 brand new',
        'Apple IWATCH SERIES 6 brand new',
        'Apple IWATCH SERIES 7 brand new',
        'Apple IWATCH SERIES 8 brand new',
        'Apple IWATCH SERIES SE (2ND GEN) brand new',
        'Apple IWATCH ULTRA brand new',
        'Apple IWATCH ULTRA 2 brand new',
        'Samsung GALAXY WATCH 4 brand new',
        'Samsung GALAXY WATCH 4 CLASSIC brand new',
        'Samsung GALAXY WATCH 5 brand new',
        'Samsung GALAXY WATCH 5 PRO brand new',
    ...
    with open('src/constants/sites/jiji/smartwatchJIJI.js', 'w') as js_file:
