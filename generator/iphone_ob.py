...
if __name__ == "__main__":
    ...
    product_names = [
        ...
        "Apple iPhone 12 Pro Max - Unlocked (Used) - 12Bgb",
        "Apple iPhone 12 Pro Max - Unlocked (Used) - 256GB",
