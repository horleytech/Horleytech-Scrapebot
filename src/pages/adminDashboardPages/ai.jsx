      ...
      <div className="">
        ...
        <div className="my-5">
          <div className="mb-8 p-4 rounded-lg border border-gray-200 bg-white w-[50%]">
            <p className="font-bold text-base mb-2">Laptop/Phone Logic Vendor List</p>
            <p className="text-sm text-gray-600 mb-3">
              Type the exact vendor names here for the strict laptop/phone extraction logic. Vendors in this list use the two-layer phone/electronics flow, while others use the general `Product | Specs | Condition | Price` flow.
            </p>
