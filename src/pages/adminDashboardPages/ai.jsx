        ...
        <div className="my-5">
          <div className="mb-8 p-4 rounded-lg border border-gray-200 bg-white w-[50%]">
            ...
            <p className="text-sm text-gray-600 mb-3">
              Type exact vendor names here to force strict laptop/phone extraction. Vendors in this list use the two-layer phone/electronics flow, while others use the general `Product | Specs | Condition | Price`, `Product | Specs | Condition | Storage | Price`, or `Product | Condition | Specs | (Storage) | Price` flow.
            </p>
