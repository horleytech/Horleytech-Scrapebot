...
const Tablet = () => {
  ...
  const [data, setData] = useState(tabletJUMIA);
  ...
  useEffect(() => {
    switch (selectedSite) {
      ...
      case 'Offline':
        ...
        return;
      default:
      // setData(tabletJUMIA); // Default to Jumia if no match
    }
    ...
    <div>
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center gap-3">
          <FaTabletAlt style={iconStyle} />
          <p className="font-bold text-[24px] text-[#1A1C23]">Tablet</p>
        </div>
      ...
      <div className="Tablet">
        <Table data={data} site={selectedSite} deviceType={'tablet'} />
      </div>
    </div>
  );
};
