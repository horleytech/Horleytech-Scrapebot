  ...
  return (
    <div className="p-4 md:p-6 max-w-7xl mx-auto bg-gradient-to-b from-slate-100 via-white to-slate-100 min-h-screen">
      ...
      <div className="mb-6 p-4 border border-amber-100 bg-amber-50 rounded-xl">
        <h3 className="text-sm font-black text-amber-800 uppercase tracking-wider mb-2">Best Format To Send Products</h3>
        <p className="text-sm text-amber-900 font-medium">
          Use this exact format for the best extraction quality:
          {' '}
        ...
        <p className="text-xs text-amber-800 mt-2">
          Example:
          {' '}
          <span className="font-black">iPhone 13 Pro | 256GB Physical SIM | UK Used | 650000</span>
        </p>
      </div>
      ...
      {mainTab === 'tips' && (
        <div className="bg-white border border-gray-200 rounded-[12px] p-5 shadow-sm">
          <div className="mb-4 p-4 border border-amber-100 bg-amber-50 rounded-xl">
            ...
            <p className="text-xs text-amber-800 mt-2">Using the pipe-separated format (<span className="font-black">|</span>) gives the highest extraction accuracy for product mapping.</p>
          </div>
