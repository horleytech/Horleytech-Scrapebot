...
const StoreFront = () => {
  ...
  const chooseWhatsappNumber = () => {
    ...
    const index = Math.floor(Math.random() * configuredNumbers.length);
    return configuredNumbers[index];
  };

  const buildWhatsappLink = (product) => {
    const selectedNumber = chooseWhatsappNumber();
    ...
    <div className="min-h-screen bg-gray-50 py-8 px-4 md:px-8">
      <div className="max-w-7xl mx-auto">
        <div className="mb-6">
          ...
          {vendorData.address && <p className="text-gray-600 mt-2">📍 {vendorData.address}</p>}
